...
let s:theme.onyx = '1a2026'

let s:theme.green = '81e079'
let s:theme.green = '7de075'
let s:theme.green = 'a9db67'
let s:theme.green = 'b0bf9d'
let s:theme.green = '8fc7b4'
let s:theme.green = '94d4be'
" let s:theme.green = '9bc4b8'
" let s:theme.green = '6bede7' " remove me
let s:theme.dark_green = '63b85c'
let s:theme.red = 'ff6055'
let s:theme.orange = 'ffc463'
let s:theme.orange = 'e3be9d'
let s:theme.orange = 'ffcca1'
let s:theme.orange = 'f5c7ab'
let s:theme.yellow = 'faf68c'
let s:theme.yellow = 'e8e899'
let s:theme.yellow = 'f2f29d'
let s:theme.yellow = 'eee8a9'
let s:theme.yellow = 'eee8a9'
" let s:theme.yellow = 'dbadd9'
" let s:theme.yellow = 'ffde73'
let s:theme.cyan = '6bede7'
let s:theme.cyan = 'abe4ed'
" let s:theme.cyan = '7de075' " remove me
let s:theme.teal = '62c4bd'
let s:theme.blue = '57c2f7'
let s:theme.blue = '6bede7' " remove me
let s:theme.blue = 'abe4ed'
let s:theme.blue = 'a6d6de'
let s:theme.indigo = '8692d9'
let s:theme.magenta = 'ff79c6'
let s:theme.magenta = 'e87bbf'
let s:theme.magenta = 'd6a7c5'
let s:theme.magenta = '89b4c4'
let s:theme.magenta = '7cb2bf'
" let s:theme.magenta = '93b6c9'
